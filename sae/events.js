import { SAEC_Events_CYCLE_UNIT, SAEC_Events_CYCLE_MAX } from './constants';
...
export class SAEO_Events {
	constructor() {
		...
		/*-----------------------------------------------------------------------*/
		this.do_cycles = function (cycles_to_add) {
