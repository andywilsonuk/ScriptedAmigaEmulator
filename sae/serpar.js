...
export class SAEO_Serial {
	constructor() {
		...
		this.rbf_clear = function () {
			ovrun = false;
		};

		this.check_irq = function () {
			if (data_in_serdatr)
		...
		this.writestatus = function (newstate, dir) {
