import { SAEC_Events_CYCLE_UNIT, SAEC_Memory_addrbank_flag_IO } from "./constants";
...
export class SAEO_Custom {
	constructor() {
		...
		function createWriteMap() {
			...
			writeMap[0x026 >> 1] = function (value, hpos) { };
