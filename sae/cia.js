import { SAEC_Events_CYCLE_UNIT, SAEC_Memory_addrbank_flag_CIA, SAEC_Memory_addrbank_flag_IO } from "./constants";
...
export class SAEO_CIA {
	constructor() {
		...
		this.b_tod_handler = function (hoffset) {
			if (!ciabtodon)
				return;
		...
		this.hsync_post = function (dotod) {
		...
		this.a_tod_inc = function (cycles) {
			//#ifdef TOD_HACK
