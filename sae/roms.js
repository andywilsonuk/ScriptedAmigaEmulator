...
export class SAEO_Roms {
	constructor() {
		...
		const roms = [
			...
			//OWN
			//68000
			new romdata("Macintosh 128K", 0, 0, 0, 0, "128K", K64, 200, 0, 0, SAEC_RomType_AMAX, 0, "", "", 0x6D0C8A28, 0, 0, 0, 0, 0),
			new romdata("Macintosh 512K", 0, 0, 0, 0, "512K", K64, 200, 0, 0, SAEC_RomType_AMAX, 0, "", "", 0xCF759E0D, 0, 0, 0, 0, 0),
			...
			new romdata("Macintosh SE", 0, 0, 0, 0, "SE", K256, 200, 0, 0, SAEC_RomType_AMAX, 0, "", "", 0x0F7FF80C, 0, 0, 0, 0, 0),
			new romdata("Macintosh SE (FDHD)", 0, 0, 0, 0, "SE", K256, 200, 0, 0, SAEC_RomType_AMAX, 0, "", "", 0xF530CB10, 0, 0, 0, 0, 0),
			...
			new romdata("Macintosh Classic", 0, 0, 0, 0, "Classic", K256, 200, 0, 0, SAEC_RomType_AMAX, 0, "", "", 0xB14DDCDE, 0, 0, 0, 0, 0),

			//68HC000 16mhz
			new romdata("Macintosh Portable", 0, 0, 0, 0, "Portable", K256, 200, 0, 0, SAEC_RomType_AMAX, 0, "", "", 0x497348F8, 0, 0, 0, 0, 0),
			new romdata("PowerBook 100", 0, 0, 0, 0, "100", K256, 200, 0, 0, SAEC_RomType_AMAX, 0, "", "", 0x29AC7EE9, 0, 0, 0, 0, 0),

			//68020 16mhz
			new romdata("Macintosh II (version 1)", 0, 0, 0, 0, "II", K256, 200, 2, 0, SAEC_RomType_AMAX, 0, "", "", 0x8C8B9D03, 0, 0, 0, 0, 0),
			new romdata("Macintosh II (version 2)", 0, 0, 0, 0, "II", K256, 200, 2, 0, SAEC_RomType_AMAX, 0, "", "", 0x4DF6D054, 0, 0, 0, 0, 0),
		...
		/*-----------------------------------------------------------------------*/
		function macintosh_calc_checksum(mem, memo, size) {
			var cksum = 0;
