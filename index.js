...
import { ScriptedAmigaEmulator } from "./sae/amiga";
...
window.onload = () => {
	document.getElementById('cfg_game').addEventListener('change', () => preSelect(1));
	document.getElementById('cfg_demo').addEventListener('change', () => preSelect(2));
	document.getElementById('cfg_tool').addEventListener('change', () => preSelect(4));
	document.getElementById('cfg_demo_aga').addEventListener('change', () => preSelect(3));
	document.getElementById('cfg_database_start').addEventListener('click', () => databaseStart());
	document.getElementById('cfg_database_config').addEventListener('click', () => switchCfg(1));
	document.getElementById('cfg_model_a1000').addEventListener('change', () => selectModelUpdate('A1000'));
	document.getElementById('cfg_model_a500').addEventListener('change', () => selectModelUpdate('A500'));
	document.getElementById('cfg_model_a500p').addEventListener('change', () => selectModelUpdate('A500P'));
	document.getElementById('cfg_model_a600').addEventListener('change', () => selectModelUpdate('A600'));
	document.getElementById('cfg_model_a1200').addEventListener('change', () => selectModelUpdate('A1200'));
	document.getElementById('cfg_model_select').addEventListener('click', () => selectModel());
	document.getElementById('cfg_blitter_immediate_0').addEventListener('change', () => immediateUpdate(1));
	document.getElementById('cfg_blitter_immediate_1').addEventListener('change', () => immediateUpdate(0));
	document.getElementById('cfg_chipset_features').addEventListener('change', () => featuresUpdate());
	document.getElementById('cfg_rom_use_aros').addEventListener('change', () => romUpdate());
	document.getElementById('cfg_rom_select').addEventListener('click', () => document.getElementById('cfg_rom_file').click());
	document.getElementById('cfg_rom_remove').addEventListener('click', () => romRemove());
	document.getElementById('cfg_rom_info').addEventListener('click', () => romOpenInfo());
	document.getElementById('cfg_rom_file').addEventListener('change', () => romSelect());
	document.getElementById('cfg_ext_select').addEventListener('click', () => document.getElementById('cfg_ext_file').click());
	document.getElementById('cfg_ext_remove').addEventListener('click', () => extRemove());
	document.getElementById('cfg_ext_info').addEventListener('click', () => extOpenInfo());
	document.getElementById('cfg_ext_file').addEventListener('change', () => extSelect());
	document.getElementById('cfg_key_select').addEventListener('click', () => document.getElementById('cfg_key_file').click());
	document.getElementById('cfg_key_remove').addEventListener('click', () => keyRemove());
	document.getElementById('cfg_key_info').addEventListener('click', () => keyOpenInfo());
	document.getElementById('cfg_key_file').addEventListener('change', () => keySelect());
	document.getElementById('cfg_amax_select').addEventListener('click', () => document.getElementById('cfg_amax_file').click());
	document.getElementById('cfg_amax_remove').addEventListener('click', () => amaxRemove());
	document.getElementById('cfg_amax_info').addEventListener('click', () => amaxOpenInfo());
	document.getElementById('cfg_amax_file').addEventListener('change', () => amaxSelect());
	document.getElementById('closeRom').addEventListener('click', () => closeRomInfo());
	document.getElementById('cfg_df0_enabled').addEventListener('change', () => floppyEnable(0));
	document.getElementById('cfg_df0_select').addEventListener('click', () => document.getElementById('cfg_df0_file').click());
	document.getElementById('cfg_df0_eject').addEventListener('click', () => floppyEject(0));
	document.getElementById('cfg_df0_info').addEventListener('click', () => floppyOpenInfo(0));
	document.getElementById('cfg_df0_file').addEventListener('change', () => floppyInsert(0));
	document.getElementById('cfg_df1_enabled').addEventListener('change', () => floppyEnable(1));
	document.getElementById('cfg_df1_select').addEventListener('click', () => document.getElementById('cfg_df1_file').click());
	document.getElementById('cfg_df1_eject').addEventListener('click', () => floppyEject(1));
	document.getElementById('cfg_df1_info').addEventListener('click', () => floppyOpenInfo(1));
	document.getElementById('cfg_df1_file').addEventListener('change', () => floppyInsert(1));
	document.getElementById('cfg_df2_enabled').addEventListener('change', () => floppyEnable(2));
	document.getElementById('cfg_df2_select').addEventListener('click', () => document.getElementById('cfg_df2_file').click());
	document.getElementById('cfg_df2_eject').addEventListener('click', () => floppyEject(2));
	document.getElementById('cfg_df2_info').addEventListener('click', () => floppyOpenInfo(2));
	document.getElementById('cfg_df2_file').addEventListener('change', () => floppyInsert(2));
	document.getElementById('cfg_df3_enabled').addEventListener('change', () => floppyEnable(3));
	document.getElementById('cfg_df3_select').addEventListener('click', () => document.getElementById('cfg_df3_file').click());
	document.getElementById('cfg_df3_eject').addEventListener('click', () => floppyEject(3));
	document.getElementById('cfg_df3_info').addEventListener('click', () => floppyOpenInfo(3));
	document.getElementById('cfg_df3_file').addEventListener('change', () => floppyInsert(3));
	document.getElementById('cfg_floppy_select_game').addEventListener('change', () => floppySelect(1));
	document.getElementById('cfg_floppy_select_demo').addEventListener('change', () => floppySelect(2));
	document.getElementById('cfg_floppy_select_demo_aga').addEventListener('change', () => floppySelect(3));
	document.getElementById('cfg_floppy_select_tool').addEventListener('change', () => floppySelect(4));
	document.getElementById('fc_type').addEventListener('change', () => floppyUpdate());
	document.getElementById('fc_standard').addEventListener('click', () => floppyCreate(1));
	document.getElementById('fc_custom').addEventListener('click', () => floppyCreate(2));
	document.getElementById('fc_close').addEventListener('click', () => floppyCloseInfo());
	document.getElementById('cfg_mount_0_enabled').addEventListener('change', () => mountEnable(0));
	document.getElementById('cfg_mount_0_select').addEventListener('click', () => document.getElementById('cfg_mount_0_file').click());
	document.getElementById('cfg_mount_0_remove').addEventListener('click', () => mountRemove(0));
	document.getElementById('cfg_mount_0_setup').addEventListener('click', () => mountOpenSetup(0));
	document.getElementById('cfg_mount_0_file').addEventListener('change', () => mountSelect(0));
	document.getElementById('cfg_mount_1_enabled').addEventListener('change', () => mountEnable(1));
	document.getElementById('cfg_mount_1_select').addEventListener('click', () => document.getElementById('cfg_mount_1_file').click());
	document.getElementById('cfg_mount_1_remove').addEventListener('click', () => mountRemove(1));
	document.getElementById('cfg_mount_1_setup').addEventListener('click', () => mountOpenSetup(1));
	document.getElementById('cfg_mount_1_file').addEventListener('change', () => mountSelect(1));
	document.getElementById('cfg_mount_2_enabled').addEventListener('change', () => mountEnable(2));
	document.getElementById('cfg_mount_2_select').addEventListener('click', () => document.getElementById('cfg_mount_2_file').click());
	document.getElementById('cfg_mount_2_remove').addEventListener('click', () => mountRemove(2));
	document.getElementById('cfg_mount_2_setup').addEventListener('click', () => mountOpenSetup(2));
	document.getElementById('cfg_mount_2_file').addEventListener('change', () => mountSelect(2));
	document.getElementById('cfg_mount_3_enabled').addEventListener('change', () => mountEnable(3));
	document.getElementById('cfg_mount_3_select').addEventListener('click', () => document.getElementById('cfg_mount_3_file').click());
	document.getElementById('cfg_mount_3_remove').addEventListener('click', () => mountRemove(3));
	document.getElementById('cfg_mount_3_setup').addEventListener('click', () => mountOpenSetup(3));
	document.getElementById('cfg_mount_3_file').addEventListener('change', () => mountSelect(3));
	document.getElementById('cfg_mount_4_enabled').addEventListener('change', () => mountEnable(4));
	document.getElementById('cfg_mount_4_select').addEventListener('click', () => document.getElementById('cfg_mount_4_file').click());
	document.getElementById('cfg_mount_4_remove').addEventListener('click', () => mountRemove(4));
	document.getElementById('cfg_mount_4_file').addEventListener('change', () => mountSelect(4));
	document.getElementById('cfg_mount_5_enabled').addEventListener('change', () => mountEnable(5));
	document.getElementById('cfg_mount_5_select').addEventListener('click', () => document.getElementById('cfg_mount_5_file').click());
	document.getElementById('cfg_mount_5_remove').addEventListener('click', () => mountRemove(5));
	document.getElementById('cfg_mount_5_file').addEventListener('change', () => mountSelect(5));
	document.getElementById('cfg_mount_surfaces').addEventListener('keypress', (event) => isDecKey(event));
	document.getElementById('cfg_mount_sectors').addEventListener('keypress', (event) => isDecKey(event));
	document.getElementById('cfg_mount_reserved').addEventListener('keypress', (event) => isDecKey(event));
	document.getElementById('cfg_mount_blocksize').addEventListener('keypress', (event) => isDecKey(event));
	document.getElementById('cfg_mount_bootpri').addEventListener('keypress', (event) => isDecKey(event, true));
	document.getElementById('mount_use').addEventListener('click', () => mountCloseSetup(1));
	document.getElementById('mount_abort').addEventListener('click', () => mountCloseSetup(0));
	document.getElementById('cfg_video_enabled').addEventListener('change', () => videoUpdate());
	document.getElementById('cfg_video_api').addEventListener('change', () => videoUpdateAPI());
	document.getElementById('cfg_video_color_mode').addEventListener('change', () => videoUpdateCM());
	document.getElementById('cfg_video_linemode').addEventListener('change', () => videoUpdateLineMode());
	document.getElementById('cfg_video_brightness').addEventListener('keypress', (event) => isDecKey(event, true));
	document.getElementById('cfg_video_background').addEventListener('keypress', (event) => isHexKey(event));
	document.getElementById('cfg_video_contrast').addEventListener('keypress', (event) => isDecKey(event, true));
	document.getElementById('cfg_video_alpha').addEventListener('keypress', (event) => isDecKey(event, false));
	document.getElementById('cfg_video_gamma').addEventListener('keypress', (event) => isDecKey(event, true));
	document.getElementById('cfg_audio_enabled').addEventListener('change', () => audioUpdate());
	document.getElementById('cfg_audio_filter').addEventListener('change', () => filterUpdate());
	document.getElementById('cfg_audio_channels').addEventListener('change', () => channelsUpdate());
	document.getElementById('cfg_ports_0').addEventListener('change', () => portUpdate(0));
	document.getElementById('cfg_ports_1').addEventListener('change', () => portUpdate(1));
	document.getElementById('cfg_start').addEventListener('click', () => advandedStart());
	document.getElementById('controls_reset').addEventListener('click', () => reset());
	document.getElementById('controls_stop').addEventListener('click', () => stop());
	document.getElementById('controls_pr').addEventListener('click', () => pause(1));
	document.getElementById('controls_mp').addEventListener('click', () => mute(1));
	document.getElementById('controls_sw').addEventListener('click', () => screen(1));
	document.getElementById('controls_do').addEventListener('click', () => dskchgOpen());
	document.getElementById('dskchg_select').addEventListener('change', () => dskchgSelect());
	document.getElementById('dskchg_abort').addEventListener('click', () => dskchgClose());
	document.getElementById('dskchg_eject').addEventListener('click', () => dskchgEject());
	document.getElementById('dskchg_abort2').addEventListener('click', () => dskchgClose());
	document.getElementById('dskchg_insert').addEventListener('click', () => document.getElementById('dskchg_file').click());
	document.getElementById('dskchg_file').addEventListener('change', () => dskchgInsert());
	init();
}